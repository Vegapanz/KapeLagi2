...
<head>
    ...
    <style>
        ...
        .custom-verify-modal .modal-title {
            font-weight: 700;
        }

        .custom-verify-modal .modal-body {
            padding: 1.25rem 1.5rem;
        }

        .custom-verify-modal .form-control {
            border-radius: 8px;
...
<body>
                    ...
                    <form class="auth-form" method="POST" action="signup.php" id="signupForm">
                        ...
                        <div class="password-group">
                            <div class="input-wrap-signup">
                                <input type="password" name="password" class="auth-input with-toggle-signup" id="password" placeholder="Password" required>
                                <button type="button" class="password-toggle-signup" data-target="password" aria-label="Toggle password visibility">
                        ...
                        <div class="password-confirm-group">
                            <div class="input-wrap-signup">
                                <input type="password" name="confirm_password" class="auth-input with-toggle-signup" id="confirm_password" placeholder="Confirm Password" required>
                                <button type="button" class="password-toggle-signup" data-target="confirm_password" aria-label="Toggle password visibility">
                                    <i class="fas fa-eye"></i>
                                </button>
                            </div>
    ...
    <script>
        ...
        (function() {
            const toggles = document.querySelectorAll('.password-toggle-signup');
        ...
        async function resendVerificationCode() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    if (msgDivLocal) {
                        msgDivLocal.textContent = '';
                        msgDivLocal.className = 'signup-verification-message';
                    }
                    if (codeEl) {
                        codeEl.value = '';
                        codeEl.focus();
